  ...
  describe('tests for get', function() {
    it('should respond 200 for "A list of publications."', function() {
      const response = request('get', 'http://localhost:3001/v2.0/data/publications', {
        'qs': {'publicationid': 5759, 'datasetid': 54134460, 'siteid': 26239, 'familyname': 'TgdGr', 'pubtype': 'Journal Article', 'year': 1852, 'search': 'ipsum minim do cupidatat', 'limit': 10, 'offset': 0},
        'time': true,
      });
