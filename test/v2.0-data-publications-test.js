  ...
  describe('tests for get', function() {
    it('should respond 200 for "A list of publications."', function() {
      const response = request('get', 'http://localhost:3001/v2.0/data/publications', {
        'qs': {'publicationid': 15375, 'datasetid': 91452635, 'siteid': 4701, 'familyname': 'eu ipsum mollit', 'pubtype': 'Master\'s Thesis', 'year': 1736, 'search': 'nostrud sunt deserunt', 'limit': 10, 'offset': 0},
        'time': true,
      });
