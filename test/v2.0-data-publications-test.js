  ...
  describe('tests for get', function() {
    it('should respond 200 for "A list of publications."', function() {
      const response = request('get', 'http://localhost:3001/v2.0/data/publications', {
        'qs': {'publicationid': 4758, 'datasetid': 19322553, 'siteid': 18668, 'familyname': 'WrCJIlIUyp', 'pubtype': 'Other Authored', 'year': 1745, 'search': 'pariatur aute officia aliqua', 'limit': 10, 'offset': 0},
        'time': true,
      });
