  ...
  describe('tests for get', function() {
    it('should respond 200 for "A list of publications."', function() {
      const response = request('get', 'http://localhost:3001/v2.0/data/publications', {
        'qs': {'publicationid': 5612, 'datasetid': 13472582, 'siteid': 3818, 'familyname': 'gVs', 'pubtype': 'Edited Book', 'year': 1977, 'search': 'nisi reprehenderit Duis do cupidatat', 'limit': 10, 'offset': 0},
        'time': true,
      });
