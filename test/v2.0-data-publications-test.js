  ...
  describe('tests for get', function () {
    it('should respond 200 for "A list of publications."', function () {
      var response = request('get', 'http://localhost:3005/v2.0/data/publications', {
        'qs': { 'publicationid': 6242, 'datasetid': 49585208, 'siteid': 18482, 'familyname': 'est esse', 'pubtype': 'Other Authored', 'year': 1650, 'search': 'dolor qui et eiusmod occaecat', 'limit': 10, 'offset': 0 },
        'time': true
      });
