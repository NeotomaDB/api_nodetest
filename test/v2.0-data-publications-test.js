  ...
  describe('tests for get', function() {
    it('should respond 200 for "A list of publications."', function() {
      const response = request('get', 'http://localhost:3001/v2.0/data/publications', {
        'qs': {'publicationid': 11347, 'datasetid': 4641500, 'siteid': 18742, 'familyname': 'pariatur', 'pubtype': 'Edited Book', 'year': 1884, 'search': 'aliquip sunt consequat', 'limit': 10, 'offset': 0},
        'time': true,
      });
